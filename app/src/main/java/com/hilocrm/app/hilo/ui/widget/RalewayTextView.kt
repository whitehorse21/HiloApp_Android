 ...
 */
class RalewayTextView: TextView {
    ...
    fun getAttributes(contex: Context, attrs: AttributeSet?) {
        ...
        val typedArray = contex.obtainStyledAttributes(attrs, R.styleable.RalewayTextView)
        val intValue = typedArray.getInt(R.styleable.RalewayTextView_textFont, 0)
