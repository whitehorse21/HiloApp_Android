 ...
 */
class RalewaySuggestionsField: AutoCompleteTextView {
    ...
    fun getAttributes(contex: Context, attrs: AttributeSet?) {
        ...
        val typedArray = contex.obtainStyledAttributes(attrs, R.styleable.RalewaySuggestionsField)
        val intValue = typedArray.getInt(R.styleable.RalewaySuggestionsField_suggestionFont, 0)
